#if 0
gcc -s -O2 -o ~/bin/mb2ff -Wno-unused-result mb2ff.c
exit
#endif
...
{
	fprintf(stderr,
		"Usage: mb2ff <letter> <?class?> <?index?>                                     \n"
		"                                                                              \n"
		"Extracts pictures from a Hero Mesh puzzle set. mb2ff reads a Free Hero Mesh   \n"
		"composite puzzle set from stdin, extracts pictures and converts them to       \n"
		...
		"                                                                              \n"
		"Example usage:                                                                \n"
		"   $ mb2ff A < image.fhm > image.ff                                           \n"
		"   $ mb2ff B 3 < image.fhm > image.ff                                         \n"
		"\n"
	);
	exit(1);
}
