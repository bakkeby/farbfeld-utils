#if 0
gcc -s -O2 -o ~/bin/mpp2ff -Wno-unused-result mpp2ff.c
exit
#endif
...
usage(void)
{
	fprintf(stderr,
		"Usage: mpp2ff                                                                 \n"
		"                                                                              \n"
		"Convert Multi Palette Picture (Atari ST) image to farbfeld. mpp2ff reads an   \n"
		"MPP image from stdin, converts it to farbfeld and writes the result to stdout.\n"
		"                                                                              \n"
		...
		"                                                                              \n"
		"Example usage:                                                                \n"
		"   $ mpp2ff < image.mpp > image.ff                                            \n"
		"   $ mpp2ff < image.mpp | bzip2 > image.ff.bz2                                \n"
		"\n"
	);
	exit(1);
}
...
static PixBuf *
decode_mpp(const Mode *mode, int ste, int extra)
{
